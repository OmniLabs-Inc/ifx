                      ...
                      <thead>
                        <tr class="activation-card-head">
                          ...
                          <th>
                            <form @submit.prevent="getBinary">
                              <input type="text" class="text-search-input form-control p-2"
                                placeholder="Search  Bonus" v-model="matching_income">
                            </form>
                          </th>
                          ...
                          <th>
                            <form @submit.prevent="getBinary">
                              <input type="text" class="text-search-input form-control p-2"
                                placeholder="Search Achieved Reward" v-model="achieved_reward">
                            </form>
                          </th>
                      ...
                      <tbody v-if="!loading">
                        ...
                        <template v-else>
                          <tr class="activation-card-data" v-for="(data, index) in filteredItems" :key="index">
                            ...
                            <td>${{ parseFloat(data.achieved_reward) }}</td>
