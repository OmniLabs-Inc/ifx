<template>
    <div>
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-6"> <!-- Adjust the column width for mobile -->
                <div class="swap_tab cus_card p-0 pt-2 pricing-column">
                    ...
                    <button @click="openModal('basic')">Buy Package</button>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-sm-6"> <!-- Adjust the column width for mobile -->
                <div class="swap_tab cus_card p-0 pt-2 pricing-column">
                    ...
                    <button @click="openModal('technical')">Buy Package</button>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-sm-6"> <!-- Adjust the column width for mobile -->
                <div class="swap_tab cus_card p-0 pt-2 pricing-column">
                    ...
                    <button @click="openModal('advanced')">Buy Package</button>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-sm-6"> <!-- Adjust the column width for mobile -->
                <div class="swap_tab cus_card p-0 pt-2 pricing-column">
                    ...
                    <button @click="openModal('expert')">Buy Package</button>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <!-- Add your form fields here -->
                    <div class="form-group">
                        <label>You are about to submit ${{ planRange }}</label>
                        <br />
                        <input type="text" class="form-control" name="invest" id="invest" v-model="planRange" readonly/>
                        <br />
...
export default {
    ...
    methods: {
        ...
        openModal(planName) {
            ...
            let resp = await ApiClass.postRequest("stake/eduplan", true, form_data);
                // console.log(resp);
