                    ...
                    <div class="col-md-12">
                        <div class="activation-card">
                            <div
                                ...
                                <h2 class="m-0">P2p Codes Generate</h2>
                                        ...
                                        <tbody v-if="!loading">
                                            ...
                                            <template v-else>
                                                <tr class="activation-card-data" v-for="(data, index) in filteredItems"
                                                    ...
                                                    <td>{{ data.redeemed_by != null ? data?.user_redeem?.user_unique_id : '' }}</td>
                                                    <td>
...
export default {
    ...
    methods: {
        async getBinary() {
            this.loading = true;
            let response = await ApiClass.getRequest(`p2p/get?page=${this.page}&per_page=${this.perPageData}&amount=${this.amount}&code=${this.code}&currency=${this.currency}&expired_at=${this.expired_at}&is_redeemed=${this.is_redeemed}&redeemed_by=${this.redeemed_by}`, true);
